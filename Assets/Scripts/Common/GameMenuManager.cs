...
public class GameMenuManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject DirectIntercatorObject;
    ...
    [SerializeField] private float maxPositionX = 3.3f;
    [SerializeField] private float minPositionX = -3.3f;
    [SerializeField] private float maxPositionZ = 3.3f;
    [SerializeField] private float minPositionZ = -3.3f;
